          ...
          <div class="container-fluid">
            <div>
                <div class="div_center">
                    <h1 style="font-size: 30px; font-weight: bold; ">Mise à jour services</h1>
               <form action="{{ url('edit_service',$data->id) }}" method="post" enctype="multipart/form-data">
                   @csrf
                 <div class="div-deg">
                    <label>nom service</label>
                    <input type="text" name="Nom" value="{{$data->nom_service}}">
                 </div>
                  <div class="div-deg">
                  ...
                  <div class="div-deg">
                    ...
                    <select name="type">
                        <option  selected value="{{$data->type_service}}">{{$data->type_service}}</option>
                    ...
                    <option selected value="yes">Oui</option>
                     ...
                     <div class="div-deg">
                      <label>Image actuelle</label>
                        <image style="margin: auto;" width="100" src="/salon/{{$data->image}}">
                    </div>
